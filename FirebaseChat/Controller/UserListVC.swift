...
extension UserListVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // ChatScreen instantiate
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ChatScreen") as! ChatScreen
        vc.receiverUserId = selectedUser.uid      // 👈 IMPORTANT
        vc.username = selectedUser.name              // Optional: show user name on top
